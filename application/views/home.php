...
<!-- Visualisation & Timeline --> 
	...
	<div id="visualisation">
		...
		<div id="container_vis" class="row">
			...
			<div id="right-container-top" class="hide">
				<a href="javascript:cleardata();" id="contentdata">Show Background</a>
			</div>
			<div id="right-container" class="hide">
	...
	//alert(nodeid);
	   ...
	   $(".inner-details").html('');
		...
		// $("#cy").addClass("col-md-offset-0 col-lg-offset-0");
		  ...
		  // $('#center-container').addClass("col-md-8 col-lg-8");
		  $('#right-container').removeClass("hide").addClass("col-md-4 col-lg-4");
