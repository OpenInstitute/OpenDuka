...
<div id="contact-us" class="row">
	...
	<div class="col-md-8 col-md-push-2">
        <form role="form" method="post" action="<?php echo $_SERVER['PHP_SELF']; ?>" id="contactform">
          <fieldset>
            <legend>We'd love to hear from you. Send us a message</legend>
            ...
            <div class="actions">
              <input type="submit" value="Send Your Message" name="submit" id="submitButton" class="btn btn-default" title="Click here to submit your message!" />
