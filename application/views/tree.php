...
<!-- Visualisation -->
	<div id="visualisation" class="section span12">
		...
		<!-- <div id="vis_checkbox" class="span12">Filter
			<?php echo form_open("tree/filter", array('id' => 'signup')); ?>
				<input type="hidden" value="" name="EntityIDS"/>
				<input style='width: 20px;' type='checkbox' name='Merge[]' value='".$content[$i]['ID']."'>People
				<input style='width: 20px;' type='checkbox' name='Merge[]' value='".$content[$i]['ID']."'>Companies
				<input style='width: 20px;' type='checkbox' name='Merge[]' value='".$content[$i]['ID']."'>Organisations
				<input style='width: 20px;' type='checkbox' name='Merge[]' value='".$content[$i]['ID']."'>Cases
				<input style='width: 20px;' type='checkbox' name='Merge[]' value='".$content[$i]['ID']."'>Grants
		 	<?php echo form_close(); ?>
		</div> -->
