...
// Images Directory
imagesDir = "http://localhost/tesseract/assets/icons/";

// CSS Directory
cssDir = "";

// Popups Directory
popupsDir = "http://localhost/tesseract/assets/popups/";
...
// Include Style Sheet
//document.write('<link rel="stylesheet" type="text/css" href="' +cssDir+ 'WYSIWYG.css">\n');
...
function generate_wysiwyg(textareaID) {
  ...
  var toolbar;
  toolbar =  '<table cellpadding="0" cellspacing="0" border="0" class="toolbar1" style="width:' + toolbarWidth + 'px;"><tr><td style="width: 6px; background:#FFFFFF"><img src="' +imagesDir+ 'seperator2.gif" alt="" hspace="3"></td>';
  ...
  var toolbar2;
  toolbar2 = '<table cellpadding="0" cellspacing="0" border="0" class="toolbar2" style="width:' + toolbarWidth + 'px;"><tr><td style="width: 6px; background:#FFFFFF"><img src="' +imagesDir+ 'seperator2.gif" alt="" hspace="3"></td>';
  ...
  toolbar2 += '<td>&nbsp;</td></tr></table>';  
	...
	var iframe = '<table cellpadding="0" cellspacing="0" border="0" style="width:' + wysiwygWidth + 'px; height:' + wysiwygHeight + 'px;border: 1px inset #ffffff; background:#FFFFFF "><tr><td valign="top">\n'
