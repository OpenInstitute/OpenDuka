...
(function($){
  ...
  $(document).ready(function(){
    ...
    sys.renderer = DeadSimpleRenderer("#cy") // our newly created renderer will have its .init() method called shortly by sys...
    ...
    var data = $.getJSON("<?php echo base_url();?>assets/js/birds/"+randBird,function(data){
